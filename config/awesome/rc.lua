...
mytextclock = wibox.widget.textclock("%I:%M:%S %p", 1)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "甲", "乙", "丙", "丁", }, s, awful.layout.layouts[1])
...
clientkeys = gears.table.join(
    ...
    awful.key({ }, "Print",
      ...
      {description = "screenshot to ~/Screenshots", group="screenshot"}),
    awful.key({ "Control"}, "Print",
      function()
        os.execute("sleep 0.2; scrot -s /tmp/scrot.png -e 'xclip -t image/png -i -selection clipboard /tmp/scrot.png'")
      end,
